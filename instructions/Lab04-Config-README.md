...
>>>>>>> 2f04d6892e37410c13bcc245984081688d24ac7b
...
```shell script
kubectl get deployment pages --namespace pages-ranganath
kubectl get cm pages-config-map  --namespace pages-ranganath
kubectl get service pages  --namespace pages-ranganath
```
